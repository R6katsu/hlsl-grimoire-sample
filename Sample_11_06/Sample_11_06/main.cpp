...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    // 最大解像度
    const int MAX_RESOLUTION = 4096;
    const int MEDIUM_RESOLUTION = MAX_RESOLUTION / 2;
    const int SMALL_RESOLUTION = MEDIUM_RESOLUTION / 2;
    const int MIN_RESOLUTION = SMALL_RESOLUTION / 2;
